...
public class EditAccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<String> editList = intent.getStringArrayListExtra("editAccount");

        ID = Integer.parseInt(editList.get(0));
        amount.setText(editList.get(1));
        typeOfBill.setText(editList.get(2));
        typeOfMoney.setText(editList.get(3));
        comment.setText(editList.get(4));
        editDate.setText(editList.get(5));
        ...
        editDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(EditAccountActivity.this, onDateSetListener, mYear, mMonth, mDay).show();
            }
        });
    ...
    public void EditData(View view){
        ...
        Log.d("add"," pressed");
        boolean isEdited = myDb.updateAccountData(
                ID,
        ...
        if(isEdited){
            Log.d("add"," isEdited");
            Toast.makeText(EditAccountActivity.this, "Data Edited", Toast.LENGTH_LONG).show();
            Intent intent = new Intent(EditAccountActivity.this, DayActivity.class);
            intent.putExtra("position", 1);
            startActivity(intent);
        }else{
            Log.d("add"," Failed");
            Toast.makeText(EditAccountActivity.this, "Failed", Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void initBillOptionData(){
        options1Items.add("clothes");
        options1Items.add("food");
        options1Items.add("home");
        options1Items.add("traffic");
        options1Items.add("communication");
        options1Items.add("entertainment");
        options1Items.add("study");
        options1Items.add("human");
        options1Items.add("medical");
        options1Items.add("financial");
    ...
    private void initMoneyOptionData(){
        ...
        moneyOptions2Items_04.add("peypel");
